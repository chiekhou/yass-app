...
class CategoryService {
      ...
      include: [
        {
          model: Category,
          as: "category",
          attributes: ["id", "name", "name_ar", "name_en", "name_de", "name_es", "name_it", "name_nl", "slug"],
        },
      ],
      attributes: [
        "id",
  ...
  async searchCategories(query) {
    const categories = await Category.findAll({
      ...
      attributes: ["id", "name", "name_ar", "name_de", "name_es", "name_it", "name_nl", "slug", "icon", "color"],
      limit: 5,
    });
      ...
      include: [
        {
          model: Category,
          as: "category",
          attributes: ["id", "name", "name_ar", "name_de", "name_es", "name_it", "name_nl", "slug"],
        },
      ],
      attributes: ["id", "name", "name_ar", "name_de", "name_es", "name_it", "name_nl", "slug", "icon"],
      limit: 5,
    });
